...
export { addData, getAllData, updateData, deleteData, getDataById, getUserByEmail, STORE_MAINTENANCE, STORE_PROPERTIES, STORE_ROOMS, STORE_USERS, STORE_BOOKINGS, STORE_ANNOUNCEMENTS };